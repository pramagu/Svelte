...
var app = (function () {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li0, file$5, 7, 2, 76);
    			add_location(li1, file$5, 8, 2, 114);
    			add_location(li2, file$5, 9, 2, 164);
    			attr_dev(ul, "class", "svelte-17jqqe0");
    			add_location(ul, file$5, 6, 1, 69);
    			attr_dev(nav, "class", "svelte-17jqqe0");
    			add_location(nav, file$5, 5, 0, 62);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src/Buscar.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 4, 0, 50);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Articulo.svelte generated by Svelte v3.55.1 */

    const file$3 = "src/Articulo.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$3, 4, 0, 71);
    			add_location(br, file$3, 4, 82, 153);
    			attr_dev(input1, "id", "precio");
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "placeholder", "Precio");
    			add_location(input1, file$3, 5, 0, 160);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*articulo*/ 1 && to_number(input1.value) !== /*articulo*/ ctx[0].precio) {
    				set_input_value(input1, /*articulo*/ ctx[0].precio);
    			}
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('Articulo', slots, ['default']);
    	let { articulo = { nombre: "", precio: 0 } } = $$props;
    	const writable_props = ['articulo'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Articulo> was created with unknown prop '${key}'`);
    	});
    ...
    class Articulo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { articulo: 0 });
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 67, 0, 1835);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	function insertar() {
    		...
    		fetch(URL.articulos, opciones).then(res => res.json()).then(doc => set_store_value(data, $data = [...$data, doc], $data)).catch(error => console.log(error));
    	}
    	...
    	function modificar() {
    		...
    		fetch(URL.articulos + documento._id, opciones).then(res => res.json()).then(datos => console.log(datos)).catch(error => console.log(error));
    	}

    	function eliminar() {
    		console.log("eliminar");
    		let opciones = { method: "DELETE" };
    		fetch(URL.articulos + documento._id, opciones).then(res => res.json()).then($data => $data.filter(doc => doc._id != documento._id)).catch(error => console.log(error));
    	}
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Boton> was created with unknown prop '${key}'`);
    	});
    ...
    class Boton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { tipo: 0, documento: 2 });
    ...
    /* src/Articulos.svelte generated by Svelte v3.55.1 */
    const file$1 = "src/Articulos.svelte";
    ...
    // (32:0) <Articulo bind:articulo={articuloInsertar}>
    function create_default_slot_1(ctx) {
    	let boton;
    	let current;

    	boton = new Boton({
    			props: { documento: /*articuloInsertar*/ ctx[1] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const boton_changes = {};
    			if (dirty & /*articuloInsertar*/ 2) boton_changes.documento = /*articuloInsertar*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:0) <Articulo bind:articulo={articuloInsertar}>",
    		ctx
    	});
    ...
    // (39:4) <Articulo bind:articulo={articulo}>
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*datosFiltrados*/ 4) boton0_changes.documento = /*articulo*/ ctx[9];
    			boton0.$set(boton0_changes);
    			const boton1_changes = {};
    			if (dirty & /*datosFiltrados*/ 4) boton1_changes.documento = /*articulo*/ ctx[9];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(39:4) <Articulo bind:articulo={articulo}>",
    		ctx
    	});
    ...
    // (37:0) {#each datosFiltrados as articulo}
    function create_each_block(ctx) {
    	...
    	function articulo_articulo_binding_1(value) {
    		/*articulo_articulo_binding_1*/ ctx[6](value, /*articulo*/ ctx[9], /*each_value*/ ctx[10], /*articulo_index*/ ctx[11]);
    	}
    	...
    	if (/*articulo*/ ctx[9] !== void 0) {
    		articulo_props.articulo = /*articulo*/ ctx[9];
    	}

    	articulo = new Articulo({ props: articulo_props, $$inline: true });
    	binding_callbacks.push(() => bind(articulo, 'articulo', articulo_articulo_binding_1));
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			br2 = element("br");
    			add_location(br0, file$1, 37, 4, 848);
    			add_location(br1, file$1, 42, 4, 1026);
    			add_location(br2, file$1, 43, 4, 1037);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const articulo_changes = {};

    			if (dirty & /*$$scope, datosFiltrados*/ 4100) {
    				articulo_changes.$$scope = { dirty, ctx };
    			}

    			if (!updating_articulo && dirty & /*datosFiltrados*/ 4) {
    				updating_articulo = true;
    				articulo_changes.articulo = /*articulo*/ ctx[9];
    				add_flush_callback(() => updating_articulo = false);
    			}

    			articulo.$set(articulo_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(37:0) {#each datosFiltrados as articulo}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	function articulo_articulo_binding(value) {
    		/*articulo_articulo_binding*/ ctx[5](value);
    	}
    	...
    	if (/*articuloInsertar*/ ctx[1] !== void 0) {
    		articulo_props.articulo = /*articuloInsertar*/ ctx[1];
    	}

    	articulo = new Articulo({ props: articulo_props, $$inline: true });
    	binding_callbacks.push(() => bind(articulo, 'articulo', articulo_articulo_binding));
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(hr, file$1, 29, 0, 694);
    			add_location(br, file$1, 34, 0, 801);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, articuloInsertar*/ 4098) {
    				articulo_changes.$$scope = { dirty, ctx };
    			}

    			if (!updating_articulo && dirty & /*articuloInsertar*/ 2) {
    				updating_articulo = true;
    				articulo_changes.articulo = /*articuloInsertar*/ ctx[1];
    				add_flush_callback(() => updating_articulo = false);
    			}
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Articulos> was created with unknown prop '${key}'`);
    	});
    	...
    	function articulo_articulo_binding(value) {
    		articuloInsertar = value;
    		$$invalidate(1, articuloInsertar);
    	}

    	function articulo_articulo_binding_1(value, articulo, each_value, articulo_index) {
    		each_value[articulo_index] = value;
    	...
    	$$self.$inject_state = $$props => {
    		if ('articuloInsertar' in $$props) $$invalidate(1, articuloInsertar = $$props.articuloInsertar);
    		...
    		if ('getArticulos' in $$props) getArticulos = $$props.getArticulos;
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$data, patron*/ 9) {
    			$$invalidate(2, datosFiltrados = $data.filter(articulo => RegExp(patron, "i").test(articulo.nombre)));
    		}
    	};
    	...
    	return [
    		...
    		articulo_articulo_binding,
    		articulo_articulo_binding_1
    	];
    }
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Route, Articulos, Clientes, Inicio });
    	return [];
    }
